package invaded.cc.core.assemble;

import invaded.cc.core.assemble.events.AssembleBoardCreatedEvent;
...
public class AssembleBoard {
	...
	private void setup(Player player) {
		...
		if(assemble.isDisplayHearts()) {
			Objective objective = scoreboard.registerNewObjective("AssembleHealth", "health");
			objective.setDisplaySlot(DisplaySlot.BELOW_NAME);
			objective.setDisplayName(CC.D_RED + "\u2764");
		}

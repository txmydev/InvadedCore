package invaded.cc.core.lunarapi.serverrule;

import invaded.cc.core.Spotify;
import invaded.cc.core.lunarapi.nethandler.client.LCPacketServerRule;
import invaded.cc.core.lunarapi.nethandler.client.obj.ServerRule;
    ...
    public void sendServerRule(Player... players) {
        ...
        for (Player player : players) {
            for (LCPacketServerRule value : CUSTOM_SERVER_RULES.values()) {
                Spotify.getInstance().getLunarHandler().sendPacket(player, value);
            }
        }
    }
}
...
public class ListCommand extends InvadedCommand {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        List<Profile> list1 = new ArrayList<>(profileHandler.getProfiles().values().stream().filter(profile -> profile.isOnline()).sorted((p1, p2) -> p2.getHighestRank().getPriority() - p1.getHighestRank().getPriority()).collect(Collectors.toList()));
